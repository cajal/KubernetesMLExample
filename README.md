...
Our recommendation is with the docker image build option if the user is not familiar with github branches, as there is pretty good chance that if the users commit the wrong branch, it will ruin the current job reliability.
